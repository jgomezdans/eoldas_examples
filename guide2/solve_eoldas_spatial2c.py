...
if __name__ == "__main__":
    ...
    file2, ideal_gamma2,r2,c2,ndvi_clean2,ndvi2,qa_flag2  = \
                prepare(nr=nr,nc=nc,noise=noise,n_per=n_per,n_scale=scale\
                        ,obs_off=obs_off*0.5,model_order=model_order,\
                        filtwindow=filtwindow)

    # set gamma to less than the the theoretical value
    gamma = ideal_gamma*0.2
    # set op file names
    xfile = 'output2/Identity/NDVI_Identity_spatial3.params'
    yfile = 'output2/Identity/NDVI_fwd_spatial3.params'
    yfile2 = 'output2/Identity/NDVI_fwd_spatial3.params'
